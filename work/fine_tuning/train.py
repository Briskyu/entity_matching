...
# dataset = '../data/dirty/iTunes-Amazon/fine_tuning'
# dataset = "../data/DBLP_Scholar/fine_tuning/"
dataset = "./data/itunes"
dataset = "./data/sepsis"
...
class DataArguments:
    ...
    train_path: str = field(default='{}/train.txt'.format(dataset), metadata={"help": "Train dataset file path."})
    dev_path: str = field(default='{}/train.txt'.format(dataset), metadata={"help": "Dev dataset file path."})
    test_path: str = field(default='{}/dev.txt'.format(dataset), metadata={"help": "Test dataset file path."})
    label_path: str = field(default='{}/label.txt'.format(dataset), metadata={"help": "Label file path."})
...
class ModelArguments:
    ...
    model_name_or_path: str = field(default=model_name, metadata={"help": "Build-in pretrained model name or the path to local model."})
...
def main():
    ...
    def compute_metrics(eval_preds):
        ...
        print(np.array(pred_ids))
        print(np.array(eval_preds.label_ids))
        metrics = {}
